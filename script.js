...
const categories = {
    BanHeang: [
        { id: 101, name: "BH Tambun Original", imageUrl: "https://example.com/path/to/image.jpg" },
        { id: 102, name: "BH Tambun Pandan" }, { id: 103, name: "BH Tambun White Lotus" },
    ...
    Sotong: [
        { id: 401, name: "Cuttlefish Red" }, { id: 402, name: "Cuttlefish Lemon" }, { id: 403, name: "Cuttlefish Honey" },
        { id: 404, name: "Cuttlefish Floss Original" }, { id: 405, name: "Cuttlefish Massive" }, { id: 406, name: "Cuttlefish Whole" },
        { id: 407, name: "Cuttlefish Roasted" }, { id: 408, name: "Cuttlefish Chili" }, { id: 409, name: "Cuttlefish Slices" },
        { id: 410, name: "Cuttlefish Sugar" }, { id: 411, name: "Five Star Cuttlefish" }
    ],
    Coffee: [
    ...
    Office: [
        ...
        { id: 909, name: "Kuih Cincin Besar (office)", unit: 'ctn' },
        { id: 910, name: "Kerepek Pisang Manis", unit: 'ctn' },{ id: 911, name: "Kerepek Pisang Masin", unit: 'ctn' }
    ]
};
